<template>
    ...
    <b-form @submit="onSubmit">
        ...
        <b-form-group label="여행 설명을 입력하세요" label-for="description-input">
        <b-form-input
    ...
    <div class="planList">
        <b-table striped hover :items="plans" :fields="plan_fields" @row-clicked="moveToPosting"></b-table>
    </div>
</div>
</template>
