    ...
    <div>
        <div id="login">
            <b-form @submit="onSubmit">
                ...
                <b-button class="ml-1" variant="warning" @click="openModal">비밀번호 찾기</b-button>
            </b-form>
                ...
                <b-modal v-model="showModal" title="비밀번호 찾기">
                    <b-form @submit="recoverPassword">
                        ...
                        <b-form-input id="name" type="text" required placeholder="이름" v-model="userName"></b-form-input>
                        </b-form-group>
                        <b-form-group id="email-input-modal" label="이메일:" label-for="email-modal">
                        <b-form-input id="email-modal" type="email" required placeholder="E-mail" v-model="userEmail"></b-form-input>
                        </b-form-group>
